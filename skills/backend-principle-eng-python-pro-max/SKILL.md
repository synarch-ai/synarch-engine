...
- `bulkheads` - Isolate thread pools and task queues
...
- `typing` - Type hints for public APIs and core logic
...
See `references/python-core.md` for stack defaults, async patterns, and tooling.
